...
MySQL - 5.7.15-log : Database - wechart
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`wechart` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
...
CREATE TABLE `sys_role_menu` (
  ...
  `menu_id` bigint(12) DEFAULT NULL COMMENT '权限id',
  `create_user` varchar(32) DEFAULT NULL COMMENT '创建人',
  `modify_user` varchar(32) DEFAULT NULL COMMENT '最后修改人',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_time` datetime DEFAULT NULL COMMENT '最后修改时间',
