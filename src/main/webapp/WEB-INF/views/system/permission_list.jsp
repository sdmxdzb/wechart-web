...
$(function(){   
	...
	dg=$('#dg').datagrid({   
	method: "get",
	url:'${ctx}/system/menu/operation/json',
    fit : true,
	fitColumns : true,
	border : false,
	idField : 'id',
...
function removemenu(){
	...
	parent.$.messager.confirm('提示', '删除后无法恢复您确定要删除？', function(data){
		if (data){
			$.ajax({
				type:'get',
				url:"${ctx}/system/menu/remove/"+row.id,
...
function change(){
	...
	d=$("#dlg").dialog({   
	    ...
	    width: 450,    
	    height: 300,    
	    href:'${ctx}/system/menu/change/'+row.id,
	    maximizable:true,
	    modal:true,
	    buttons:[{
			text:'确认',
