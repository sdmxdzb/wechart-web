...
<div>
	...
	<table  class="formTable">
		...
		<tr>
			<td>上级菜单：</td>
			<td><input id="parentId" name="parentId" value="${menu.parentId}"/></td>
		</tr>
		<tr>
			<td>排序：</td>
			<td><input id="sortNo" type="text" name="sortNo" value="${menu.sortNo }" class="easyui-numberbox" data-options="width: 180" /></td>
		</tr>
		<tr>
			<td>描述：</td>
			<td><textarea rows="3" cols="41" name="description">${menu.description}</textarea></td>
		</tr>
	</table>
	</form>
</div> 
